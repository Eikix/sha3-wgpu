  ...
  return (
    <div className="app">
      ...
      {webgpuSupported !== null && (
        <div className={`webgpu-check ${webgpuSupported ? 'supported' : 'not-supported'}`}>
          {webgpuSupported ? (
            <>
              <strong>WebGPU is supported!</strong>
              <span>Your browser supports WebGPU. You can run the GPU-accelerated demos.</span>
            </>
          ) : (
            <>
              <strong>WebGPU is not supported</strong>
              <span>
                Your browser doesn't support WebGPU. Please use Chrome/Edge 113+ or other browsers with WebGPU enabled.
                Visit <a href="https://webgpu.io" target="_blank" rel="noopener noreferrer" style={{color: '#fca5a5'}}>webgpu.io</a> for more information.
              </span>
            </>
          )}
        </div>
