...
function AllVariantsDemo() {
  ...
  const handleHashAllVariants = async () => {
    ...
    try {
      ...
      for (const variant of VARIANTS) {
        ...
        setOutput((prev) => [
          ...prev,
          `  ${variant.label} (${variant.outputSize} bytes): ${hashHex}`,
          "",
        ]);
      }
  ...
  return (
    <div>
      <h2>All SHA-3 Variants</h2>
      <p>
        Test different SHA-3 variants including SHA3-224, SHA3-256, SHA3-384,
        SHA3-512, and the extendable-output functions SHAKE128 and SHAKE256.
      </p>
